...
#exit_rope
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"脱出用ロープ","italic":false}]',Lore:['{"text":"使用者のいる座標の","italic":false}','{"text":"一番上にあるブロックにテレポートする。","italic":false}','{"text":"使用後は疲労で動けなくなる。","italic":false}']},CustomModelData:1}}}] if score @s ninzin matches 1 run tag @s add exit_rope_user
execute as @a[tag=exit_rope_user] at @s run spreadplayers ~ ~ 0 1 false @s
execute as @a[tag=exit_rope_user] run clear @s minecraft:carrot_on_a_stick{display:{Name:'[{"text":"脱出用ロープ","italic":false}]',Lore:['{"text":"使用者のいる座標の","italic":false}','{"text":"一番上にあるブロックにテレポートする。","italic":false}','{"text":"使用後は疲労で動けなくなる。","italic":false}']},CustomModelData:1} 1
...
#hunting_eye
execute as @a[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'[{"text":"Hunting eye","italic":false}]',Lore:['{"text":"使用者のから20m以内の","italic":false}','{"text":"相手プレイヤーに発光効果を","italic":false}','{"text":"10秒付与する","italic":false}']},CustomModelData:2}}}] if score @s ninzin matches 1 run tag @s add hunting_eye_user
execute as @a[tag=hunting_eye_user] run clear @s minecraft:carrot_on_a_stick{display:{Name:'[{"text":"Hunting eye","italic":false}]',Lore:['{"text":"使用者のから20m以内の","italic":false}','{"text":"相手プレイヤーに発光効果を","italic":false}','{"text":"10秒付与する","italic":false}']},CustomModelData:2} 1
...
execute as @a[scores={GUIother=0}] store success score @s GUIother run clear @s minecraft:blue_stained_glass_pane{display:{Name:'{"text":"other","italic":false}'}} 1
...
execute as @a[scores={craft_octane_potion=0}] store success score @s craft_octane_potion run clear @s minecraft:splash_potion{display:{Name:'[{"text":"興奮剤を作るx3","italic":false}]',Lore:['{"text":"[必要素材]","italic":false}','{"text":"砂糖x3","italic":false}','{"text":"火薬x1","italic":false}','{"text":"種x1","italic":false}','{"text":"ガラス瓶x1","italic":false}']},CustomPotionEffects:[{Id:1b,Amplifier:2b,Duration:160,Ambient:false,ShowParticles:false},{Id:8b,Amplifier:2b,Duration:160,Ambient:false,ShowParticles:false}],CustomPotionColor:5635925} 1
...
execute at @a[scores={GUIpotion=1}] run item replace entity @e[type=minecraft:chest_minecart,limit=1,sort=nearest] container.13 with minecraft:splash_potion{display:{Name:'[{"text":"興奮剤を作るx3","italic":false}]',Lore:['{"text":"[必要素材]","italic":false}','{"text":"砂糖x3","italic":false}','{"text":"火薬x1","italic":false}','{"text":"種x1","italic":false}','{"text":"ガラス瓶x1","italic":false}']},CustomPotionEffects:[{Id:1b,Amplifier:2b,Duration:160,Ambient:false,ShowParticles:false},{Id:8b,Amplifier:2b,Duration:160,Ambient:false,ShowParticles:false}],CustomPotionColor:5635925}
...
#青ガラス削除
clear @a minecraft:blue_stained_glass_pane 64